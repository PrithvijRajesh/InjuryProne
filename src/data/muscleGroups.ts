export type PolygonShape = { kind: 'polygon'; points: string };
...
export const DECORATIVE_SHAPES: Record<'front' | 'back', Shape[]> = {
  front: [
    ...poly('424 29 400 118 420 196 461 233 498 253 547 224 576 192 592 102 571 24 498 0'), // head
    ...poly(
    ...
    ...poly('694 555 694 616 759 727 776 702 755 673', '224 694 298 555 298 608 229 731'), // triceps sliver (front angle)
    ...poly(
  ...
  back: [
    ...
    ...poly('294 370 230 391 174 443 183 536 243 494 272 464', '711 370 783 396 826 447 817 536 749 489 723 451'), // back deltoids
    ...poly(
    ...
    ...poly('345 1532 311 1591 336 1664 374 1626', '664 1536 630 1630 668 1664 694 1591'), // knees
  ],
};
...
export const MUSCLE_GROUPS: MuscleGroup[] = [
  ...
  },
  {
    ...
    name: 'Biceps',
    view: 'front',
    shapes: poly('167 682 180 714 229 661 290 539 278 494 204 559', '714 494 702 547 763 661 816 718 829 690 788 555'),
  },
  {
    id: 'forearms',
    name: 'Forearms',
  ...
  },
  {
    ...
    name: 'Lower Back',
    view: 'back',
    shapes: poly('477 728 345 770 353 834 494 1021 468 830', '523 728 655 770 647 834 506 1021 532 838'),
  },
  {
    id: 'triceps',
    name: 'Triceps',
